...
const organization = require('../shared/better-auth.Bkp9jjoM.cjs');
...
const admin = require('../shared/better-auth.D39hJv0B.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.CHOXmdan.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.BjJpNA74.cjs');
...
require('../shared/better-auth.Bh1RMCrC.cjs');
